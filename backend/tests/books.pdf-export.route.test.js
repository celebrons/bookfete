...
describe('POST /api/books/:id/export-final-pdf — livre sans-IA (zero chapitre)', () => {
  ...
  it('le job se termine "ready" en utilisant le pipeline sans-IA (pdfService.renderPdfByPrinting)', async () => {
    ...
    // double page reste entiere. La couverture et la 4e gardent leur propre
    // taille grace aux @page nommees — c est ce qui manquait a la premiere
    // tentative, retiree le 2026-09-19 parce qu elle mettait la couverture au
    // milieu d un vide grand comme une page.
