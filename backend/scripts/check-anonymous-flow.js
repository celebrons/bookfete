...
//
// Necessite que le backend tourne (localhost:5000).
...
require('dotenv').config({ path: 'c:/Users/USER/bookfete/frontend/.env' });
...
require('dotenv').config({ path: 'c:/Users/USER/bookfete/backend/.env', override: true });
